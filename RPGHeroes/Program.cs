...
var armor = new Armor("Clonk's Bonk", 2, itemSlot.Chest, new(1, 1, 1, 0, 0, 0));

var armor2 = new Armor("Clank's Bank", 2, itemSlot.Chest, new(1, 1, 1, 0, 0, 0));

var armor3 = new Armor("Clink's Bink", 2, itemSlot.Legs, new(1, 1, 1, 0, 0, 0));
...
Console.WriteLine(mage.EquippedItems.Count);